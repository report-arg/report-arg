        ...
        <div className="reset-left">
          ...
          <div className="reset-left-content">
            <h1 className="reset-title">
              Construyendo una<br />comunidad más<br />segura.
            </h1>
            <p className="reset-description">
              Define el nivel institucional para la gestión y reporte 
              inteligente de incidentes. Tecnología al servicio del ciudadano.
            </p>
          </div>
        </div>
          ...
          <div className="reset-form">
            ...
            <div className="reset-success">
              ...
              <p className="reset-success-text">
                Revisa tu casilla de correo. Te enviamos las instrucciones para 
